...
public class DownloadSchemaTests_MySql_09_07 : DownloadSchemaTests<MySqlBuilder, MySqlContainer, DownloadSchemaTests_MySql_09_07.ThisFixture>
{
    protected override string IfClauseOpen => "(";
    protected override string IfClauseClose => ")";

    public DownloadSchemaTests_MySql_09_07(ThisFixture fixture)
    {
        Fixture = fixture;
    }
