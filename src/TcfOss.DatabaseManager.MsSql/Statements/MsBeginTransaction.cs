...
/// <summary>
/// T-SQL <c>BEGIN { TRAN | TRANSACTION } [transaction_name]</c>.
/// </summary>
public record MsBeginTransaction(TransactionNoun Noun) : Statement
{
    public Identifier? Name { get; init; }

    public override void ToSql(SqlTextWriter writer)
    {
        writer.WriteSql($"BEGIN {Noun}");
        if (Name != null)
        {
