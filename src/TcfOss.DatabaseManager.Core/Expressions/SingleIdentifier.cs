...
public record SingleIdentifier(Identifier Identifier) : Expression
{
    public SourceRef? Source => Identifier.Source;

    public override void ToSql(SqlTextWriter writer)
    {
        Identifier.ToSql(writer);
    }

    public override void FormatSql(SqlTextWriter writer, FormatManager manager)
    {
        SqlValueList<Identifier> identifiers = [Identifier];
        ...
        identifiers = manager.QuoteIdentifiers([Identifier], identifiers);
